...
for run, seed in enumerate(seeds):
    ...
    if not load_experiment:
        ...
        # onp.savez(
        #     data_folder_save/'optimal_data_robot.npz', 
        #     L=onp.array(L_opt), 
        #     D=onp.array(D_opt),
        #     r=onp.array(r_opt),
        ...
        # if train_unique_controller:
        #     mlp_controller_opt.save_params(data_folder_save/'optimal_data_controller.npz')
        # else:
        #     fb_mlp_controller_opt.save_params(data_folder_save/'optimal_data_fb_controller.npz')
        #     ff_mlp_controller_opt.save_params(data_folder_save/'optimal_data_ff_controller.npz')
        ...
        #     case _:
        #         onp.savez(
        #             data_folder_save/'optimal_data_map.npz', 
        #             A=onp.array(A_opt), 
        #             c=onp.array(c_opt)
        #         )
    ...
    if load_experiment:
        ...
        data_robot_opt = onp.load(data_folder_load/f'{prefix_load}optimal_data_robot.npz')
        ...
        if train_unique_controller:
            p_controller_opt = mlp_controller.load_params(data_folder_load/f'{prefix_load}optimal_data_controller.npz')
            mlp_controller_opt = mlp_controller.update_params(p_controller_opt)
        else:
            p_fb_controller_opt = fb_mlp_controller.load_params(data_folder_load/f'{prefix_load}optimal_data_fb_controller.npz')
            p_ff_controller_opt = ff_mlp_controller.load_params(data_folder_load/f'{prefix_load}optimal_data_ff_controller.npz')
            fb_mlp_controller_opt = fb_mlp_controller.update_params(p_fb_controller_opt)
            ff_mlp_controller_opt = ff_mlp_controller.update_params(p_ff_controller_opt)
        ...
        match map_to_train:
            ...
            case 'norm_flow':
                ...
                map_opt = map.update_params(p_map_opt)
            case _:
                data_map_opt = onp.load(data_folder_load/f'{prefix_load}optimal_data_map.npz')
    ...
    # with open(data_folder_save/f'metrics{suffix_log}.txt', 'w') as file:
    #     file.write(f"SETUP\n")
