...
load_case_prefix = 'SAMPLES_REGULMAP' # if train_samples is False, choose prefix of the experiment to load
...
def Loss(
    ...
    alpha = 0.0 # regularization weight
    ...
    # overall loss
    loss = MSE + alpha * regul_controller + beta * regul_map
