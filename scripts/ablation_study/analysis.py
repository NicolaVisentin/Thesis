...
do_regulmap_case = False
do_regulall_case = False
do_overall = True

do_coupled_case = False
do_tanhQ_svd_case = False
...
if do_ref_case or do_overall:
    ...
    if do_ref_case:
        ...
        for i in range(n_pcs):
            axs[0,0].plot(timePCS_before, q_PCS_before[:,3*i], label=f'segment {i+1}')
            axs[0,0].grid(True)
            axs[0,0].set_xlabel('t [s]')
            axs[0,0].set_ylabel(r"$\kappa_\mathrm{be}$ [rad/m]")
            axs[0,0].set_title('Bending strain')
            axs[0,0].legend()
            axs[1,0].plot(timePCS_before, q_PCS_before[:,3*i+1], label=f'segment {i+1}')
            axs[1,0].grid(True)
            axs[1,0].set_xlabel('t [s]')
            axs[1,0].set_ylabel(r"$\sigma_\mathrm{ax}$ [-]")
            axs[1,0].set_title('Axial strain')
            axs[1,0].legend()
            axs[2,0].plot(timePCS_before, q_PCS_before[:,3*i+2], label=f'segment {i+1}')
            axs[2,0].grid(True)
            ...
            axs[2,0].legend()
        for i in range(n_pcs):
            axs[0,1].plot(timePCS_before, u_pcs_before[:,3*i], label=f'segment {i+1}')
            axs[0,1].grid(True)
            axs[0,1].set_xlabel('t [s]')
            axs[0,1].set_ylabel(r"$u_\mathrm{be}$ [$N \cdot m^{2}$]")
            axs[0,1].set_title('Bending actuation')
            axs[0,1].legend()
            axs[1,1].plot(timePCS_before, u_pcs_before[:,3*i+1], label=f'segment {i+1}')
            axs[1,1].grid(True)
            axs[1,1].set_xlabel('t [s]')
            axs[1,1].set_ylabel(r"$u_\mathrm{ax}$ [$N \cdot m$]")
            axs[1,1].set_title('Axial actuation')
            axs[1,1].legend()
            axs[2,1].plot(timePCS_before, u_pcs_before[:,3*i+2], label=f'segment {i+1}')
            axs[2,1].grid(True)
        ...
        fig, axs = plt.subplots(3,2, figsize=(12,9))
        for i in range(n_pcs):
            axs[0,0].plot(timePCS_after, q_PCS_after[:,3*i], label=f'segment {i+1}')
            axs[0,0].grid(True)
            axs[0,0].set_xlabel('t [s]')
            axs[0,0].set_ylabel(r"$\kappa_\mathrm{be}$ [rad/m]")
            axs[0,0].set_title('Bending strain')
            axs[0,0].legend()
            axs[1,0].plot(timePCS_after, q_PCS_after[:,3*i+1], label=f'segment {i+1}')
            axs[1,0].grid(True)
            axs[1,0].set_xlabel('t [s]')
            axs[1,0].set_ylabel(r"$\sigma_\mathrm{ax}$ [-]")
            axs[1,0].set_title('Axial strain')
            axs[1,0].legend()
            axs[2,0].plot(timePCS_after, q_PCS_after[:,3*i+2], label=f'segment {i+1}')
            axs[2,0].grid(True)
            axs[2,0].set_xlabel('t [s]')
            axs[2,0].set_ylabel(r"$\sigma_\mathrm{sh}$ [-]")
            axs[2,0].set_title('Shear strain')
            axs[2,0].legend()
        for i in range(n_pcs):
            axs[0,1].plot(timePCS_after, u_pcs_after[:,3*i], label=f'segment {i+1}')
            axs[0,1].grid(True)
            axs[0,1].set_xlabel('t [s]')
            axs[0,1].set_ylabel(r"$u_\mathrm{be}$ [$N \cdot m^{2}$]")
            axs[0,1].set_title('Bending actuation')
            axs[0,1].legend()
            axs[1,1].plot(timePCS_after, u_pcs_after[:,3*i+1], label=f'segment {i+1}')
            axs[1,1].grid(True)
            axs[1,1].set_xlabel('t [s]')
            axs[1,1].set_ylabel(r"$u_\mathrm{ax}$ [$N \cdot m$]")
            axs[1,1].set_title('Axial actuation')
            axs[1,1].legend()
            axs[2,1].plot(timePCS_after, u_pcs_after[:,3*i+2], label=f'segment {i+1}')
            axs[2,1].grid(True)
            axs[2,1].set_xlabel('t [s]')
            axs[2,1].set_ylabel(r"$u_\mathrm{sh}$ [$N \cdot m$]")
            axs[2,1].set_title('Shear actuation')
        ...
        for i in range(n_pcs):
            axs[0].plot(timePCS_before, qd_PCS_before[:,3*i] * u_pcs_before[:,3*i], label=f'segment {i+1}')
            axs[0].grid(True)
            axs[0].set_xlabel('t [s]')
            axs[0].set_ylabel(r"$P_\mathrm{be}$ [W]")
            axs[0].set_title('Bending actuation power')
            axs[0].legend()
            axs[1].plot(timePCS_before, qd_PCS_before[:,3*i+1] * u_pcs_before[:,3*i+1], label=f'segment {i+1}')
            axs[1].grid(True)
            axs[1].set_xlabel('t [s]')
            axs[1].set_ylabel(r"$P_\mathrm{ax}$ [W]")
            axs[1].set_title('Axial actuation power')
            axs[1].legend()
            axs[2].plot(timePCS_before, qd_PCS_before[:,3*i+2] * u_pcs_before[:,3*i+2], label=f'segment {i+1}')
            axs[2].grid(True)
        ...
        fig, axs = plt.subplots(3,1, figsize=(10,6))
        for i in range(n_pcs):
            axs[0].plot(timePCS_after, qd_PCS_after[:,3*i] * u_pcs_after[:,3*i], label=f'segment {i+1}')
            axs[0].grid(True)
            axs[0].set_xlabel('t [s]')
            axs[0].set_ylabel(r"$P_\mathrm{be}$ [W]")
            axs[0].set_title('Bending actuation power')
            axs[0].legend()
            axs[1].plot(timePCS_after, qd_PCS_after[:,3*i+1] * u_pcs_after[:,3*i+1], label=f'segment {i+1}')
            axs[1].grid(True)
            axs[1].set_xlabel('t [s]')
            axs[1].set_ylabel(r"$P_\mathrm{ax}$ [W]")
            axs[1].set_title('Axial actuation power')
            axs[1].legend()
            axs[2].plot(timePCS_after, qd_PCS_after[:,3*i+2] * u_pcs_after[:,3*i+2], label=f'segment {i+1}')
            axs[2].grid(True)
            axs[2].set_xlabel('t [s]')
            axs[2].set_ylabel(r"$P_\mathrm{sh}$ [W]")
            axs[2].set_title('Shear actuation power')
...
# =====================================================
if do_regulall_case or do_overall:
    print(f'\n--- REGULARIZATION MAP+MLP CASE ---')
    test_case = '3.4_regulAll'
    (plots_folder/test_case).mkdir(parents=True, exist_ok=True)

    ##### ALL SAMPLES #####
    prefix = 'SAMPLES_REGULALL'
    ...
    all_val_mse_ts = all_loss_curves["val_MSEs_ts"]
    all_rmse_before = all_rmse_before["RMSE_before"]
    SAMPLES_REGULALL_all_rmse_after = all_rmse_after["RMSE_after"]
    n_samples = all_rmse_before.shape[0]
    SAMPLES_REGULALL_all_powers_msv_after = all_powers_msv_after["powers_msv_after"]
    n_epochs_samples = all_train_mse_ts.shape[1]

    # Compute "mapping effort" for each sample (after training)
    print('Computing mapping effort (after training)')
    SAMPLES_REGULALL_mapping_effort_after = []
    for i in range(n_samples):
        robot_i = robot.update_params({
            "L": jnp.array(all_robot_params_after["L_after"][i]), 
            "D": jnp.diag(all_robot_params_after["D_after"][i]),
        ...
        map_i = partial(map, A=jnp.array(all_map_after["A_after"][i]), c=jnp.array(all_map_after["c_after"][i]))
        mapping_effort_i = mean_Ek_ratio(robot_i, RON_dataset, map_i)
        SAMPLES_REGULALL_mapping_effort_after.append(mapping_effort_i)
    ...
    ##### BEST RESULT #####
    prefix = 'BEST_REGULALL'

    # Load and extract data (training)
    loss_curves = onp.load(data_folder/test_case/f'{prefix}_all_loss_curves.npz')
    REGULALL_train_loss_ts = loss_curves["train_losses_ts"][0]
    REGULALL_val_loss_ts = loss_curves["val_losses_ts"][0]
    REGULALL_train_mse_ts = loss_curves["train_MSEs_ts"][0]
    REGULALL_val_mse_ts = loss_curves["val_MSEs_ts"][0]
    n_epochs = len(REGULALL_train_loss_ts)
    ...
    # Load and extract data (after training)
    BEST_REGULALL_rmse_after = onp.load(data_folder/test_case/f'{prefix}_all_rmse_after.npz')["RMSE_after"][0]

    CONTR_after = mlp_controller.load_params(data_folder/test_case/f'{prefix}_all_data_controller_after.npz')
    CONTR_after = mlp_controller.extract_params_from_batch(CONTR_after, 0) # controller data are always saved as batches
    controller_after = mlp_controller.update_params(CONTR_after)
    powers_msv_after = onp.load(data_folder/test_case/f'{prefix}_all_powers_msv_after.npz')
    BEST_REGULALL_powers_msv_after = powers_msv_after["powers_msv_after"][0]
    ...
    # Compute mapping effort (after training)
    BEST_REGULALL_mapping_effort_after = mean_Ek_ratio(
        robot_after, 
        RON_dataset, 
        partial(map, A=A_after, c=c_after)
    )
    BEST_REGULALL_condAinv = jnp.linalg.cond(jnp.linalg.inv(A_after))
    ...
    if do_regulall_case:
        ...
        # Compute simulation metrics
        BEST_REGULALL_simulationPower = compute_simulation_power(u_pcs_after, qd_PCS_after)
        BEST_REGULALL_simulationAccuracy = compute_simulation_rmse(timePCS_after, y_hat_pcs_after, time_RONsaved, y_RONsaved)
        BEST_REGULALL_simulationMapeffort = compute_simulation_Ek_ratio(robot_after, timePCS_after, q_PCS_after, qd_PCS_after, time_RONsaved, yd_RONsaved)

        # Show loss curve
        plt.figure()
        plt.plot(range(n_epochs), REGULALL_train_mse_ts, 'r', label='train MSE')
        plt.plot(onp.arange(1,n_epochs+1), REGULALL_val_mse_ts, 'b', label='validation MSE')
        plt.plot(range(n_epochs), REGULALL_train_loss_ts, 'r--', label='train loss')
        plt.plot(onp.arange(1,n_epochs+1), REGULALL_val_loss_ts, 'b--', label='validation loss')
        plt.grid(True)
        plt.xlabel('epoch')
        plt.ylabel('loss')
        plt.title('Result for best initial guess')
        ...
        with open(plots_folder/test_case/'best_result_parameters.txt', 'w') as file:
            ...
            file.write(f'c = {c_after}\n')
            file.write(f'\nCONTROLLER:\n')
            file.write(f'RMS power on the test set = {onp.sqrt(BEST_REGULALL_powers_msv_after)}\n')
...
# Tanh(W*q+b), SVD case
# =====================================================
if do_tanhQ_svd_case:
    print(f'\n--- SIMPLER tanh(W*q+b) CONTROLLER CASE ---')
    test_case = '100TEMP_tanhQ_svd'
    (plots_folder/test_case).mkdir(parents=True, exist_ok=True)

    mlp_controller_simpler = MLP(key, [3*n_pcs, 3*n_pcs]) # different controller layers
    def tau_law_simpler(system_state: SystemState, controller: MLP):
        """Implements user-defined feedback control tau(t) = MLP(q(t),qd(t))."""
    ...
    ##### BEST RESULT #####
    prefix = '2.1_TANHQ_SVD_BEST'

    # Load and extract data (training)
    loss_curves = onp.load(data_folder/test_case/f'{prefix}_all_loss_curves.npz')
    TANHQ_train_loss_ts = loss_curves["train_losses_ts"][0]
    TANHQ_val_loss_ts = loss_curves["val_losses_ts"][0]
    n_epochs = len(TANHQ_train_loss_ts)

    # Load and extract data (before training)
    CONTR_before = mlp_controller_simpler.load_params(data_folder/test_case/f'{prefix}_all_data_controller_before.npz')
    CONTR_before = mlp_controller_simpler.extract_params_from_batch(CONTR_before, 0) # controller data are always saved as batches
    controller_before = mlp_controller_simpler.update_params(CONTR_before)
    powers_msv_before = onp.load(data_folder/test_case/f'{prefix}_all_powers_msv_before.npz')
    powers_msv_before = powers_msv_before["powers_msv_before"][0]
    ...
    # Load and extract data (after training)
    BEST_TANHQ_rmse_after = onp.load(data_folder/test_case/f'{prefix}_all_rmse_after.npz')["RMSE_after"][0]

    CONTR_after = mlp_controller_simpler.load_params(data_folder/test_case/f'{prefix}_all_data_controller_after.npz')
    CONTR_after = mlp_controller_simpler.extract_params_from_batch(CONTR_after, 0) # controller data are always saved as batches
    controller_after = mlp_controller_simpler.update_params(CONTR_after)
    powers_msv_after = onp.load(data_folder/test_case/f'{prefix}_all_powers_msv_after.npz')
    ...
    if do_tanhQ_svd_case:
        ...
        tau_fb = jax.jit(partial(tau_law_simpler, controller=controller_before)) # signature u(SystemState) -> (control_u, control_state_dot) required by soromox
        ...
        tau_fb = jax.jit(partial(tau_law_simpler, controller=controller_after)) # signature u(SystemState) -> (control_u, control_state_dot) required by soromox
        ...
        # Show loss curve
        plt.figure()
        plt.plot(range(n_epochs), TANHQ_train_loss_ts, 'r', label='train loss')
        plt.plot(onp.arange(1,n_epochs+1), TANHQ_val_loss_ts, 'b', label='validation loss')
        plt.grid(True)
        plt.xlabel('epoch')
        plt.ylabel('loss')
        plt.title('Result for best initial guess')
...
if do_overall:
    ...
    plt.figure()
    plt.scatter(SAMPLES_REF_all_rmse_after, onp.sqrt(SAMPLES_REF_all_powers_msv_after), color='#000000', label='reference')
    plt.scatter(SAMPLES_NOPCS_all_rmse_after, onp.sqrt(SAMPLES_NOPCS_all_powers_msv_after), color='#FF0000', label='no pcs')
    plt.scatter(SAMPLES_NOMAP_all_rmse_after, onp.sqrt(SAMPLES_NOMAP_all_powers_msv_after), color='#008000', label='no map')
    plt.scatter(SAMPLES_DIAGMAP_all_rmse_after, onp.sqrt(SAMPLES_DIAGMAP_all_powers_msv_after), color='#00FFFF', label='diagonal map')
    plt.vlines(SAMPLES_NOMLP_all_rmse_after, -1*onp.ones_like(SAMPLES_NOMLP_all_rmse_after), plt.ylim()[1]*onp.ones_like(SAMPLES_NOMLP_all_rmse_after), color='#FF00FF', alpha=0.2, label='no fb controller')
    plt.scatter(SAMPLES_REGULMLP_all_rmse_after, onp.sqrt(SAMPLES_REGULMLP_all_powers_msv_after), color='#FFBB00', label='control penalty')
    plt.scatter(SAMPLES_REGULMAP_all_rmse_after, onp.sqrt(SAMPLES_REGULMAP_all_powers_msv_after), color='#0000FF', label='map penalty')
    plt.scatter(SAMPLES_REGULALL_all_rmse_after, onp.sqrt(SAMPLES_REGULALL_all_powers_msv_after), color='#D3D3D3', label='map+control penalty')
    plt.xscale('log')
    plt.yscale('log')
    plt.grid(True)
    ...
    plt.figure()
    plt.scatter(SAMPLES_REF_all_rmse_after, SAMPLES_REF_mapping_effort_after, color='#000000', label='reference')
    plt.scatter(SAMPLES_NOPCS_all_rmse_after, SAMPLES_NOPCS_mapping_effort_after, color='#FF0000', label='no pcs')
    plt.scatter(SAMPLES_NOMAP_all_rmse_after, SAMPLES_NOMAP_mapping_effort_after, color='#008000', label='no map')
    plt.scatter(SAMPLES_DIAGMAP_all_rmse_after, SAMPLES_DIAGMAP_mapping_effort_after, color='#00FFFF', label='diagonal map')
    plt.scatter(SAMPLES_NOMLP_all_rmse_after, SAMPLES_NOMLP_mapping_effort_after, color='#FF00FF', label='no fb controller')
    plt.scatter(SAMPLES_REGULMLP_all_rmse_after, SAMPLES_REGULMLP_mapping_effort_after, color='#FFBB00', label='control penalty')
    plt.scatter(SAMPLES_REGULMAP_all_rmse_after, SAMPLES_REGULMAP_mapping_effort_after, color='#0000FF', label='map penalty')
    plt.scatter(SAMPLES_REGULALL_all_rmse_after, SAMPLES_REGULALL_mapping_effort_after, color='#D3D3D3', label='map+control penalty')
    plt.xscale('log')
    plt.yscale('log')
    plt.grid(True)
    plt.xlabel('RMS error on test set')
    ...
    plt.figure()
    plt.plot(1+onp.arange(len(REF_val_loss_ts)), onp.sqrt(REF_val_loss_ts), color='#000000', label='reference')
    plt.plot(1+onp.arange(len(NOPCS_val_loss_ts)), onp.sqrt(NOPCS_val_loss_ts), color='#FF0000', label='no pcs')
    plt.plot(1+onp.arange(len(NOMAP_val_loss_ts)), onp.sqrt(NOMAP_val_loss_ts), color='#008000', label='no map')
    plt.plot(1+onp.arange(len(DIAGMAP_val_loss_ts)), onp.sqrt(DIAGMAP_val_loss_ts), color='#00FFFF', label='diagonal map')
    plt.plot(1+onp.arange(len(NOMLP_val_loss_ts)), onp.sqrt(NOMLP_val_loss_ts), color='#FF00FF', label='no fb controller')
    plt.plot(1+onp.arange(len(REGULMLP_val_mse_ts)), onp.sqrt(REGULMLP_val_mse_ts), color="#FFBB00", label='control penalty')
    plt.plot(1+onp.arange(len(REGULMAP_val_mse_ts)), onp.sqrt(REGULMAP_val_mse_ts), color='#0000FF', label='map penalty')
    plt.plot(1+onp.arange(len(REGULALL_val_mse_ts)), onp.sqrt(REGULALL_val_mse_ts), color='#D3D3D3', label='map+control penalty')
    plt.grid(True)
    plt.xlabel('epoch')
    plt.ylabel('RMSE')
    plt.title('Validation RMSEs')
    plt.legend()
    plt.yscale('log')
    plt.tight_layout()
    ...
    if do_ref_case and do_nopcs_case and do_nomap_case and do_diagmap_case and do_nomlp_case and do_regulmlp_case and do_regulmap_case:
        plt.scatter(BEST_REF_simulationAccuracy, BEST_REF_simulationPower, color='#000000', marker='+')
        plt.scatter(BEST_NOPCS_simulationAccuracy, BEST_NOPCS_simulationPower, color='#FF0000', marker='+')
        if BEST_NOMAP_simulationAccuracy < 1e10 and BEST_NOMAP_simulationPower < 1e10:
            plt.scatter(BEST_NOMAP_simulationAccuracy, BEST_NOMAP_simulationPower, color='#008000', marker='+')
        plt.scatter(BEST_DIAGMAP_simulationAccuracy, BEST_DIAGMAP_simulationPower, color='#00FFFF', marker='+')
        y_axis_max = plt.ylim()[1]
        plt.vlines(BEST_NOMLP_simulationAccuracy, -1, y_axis_max, color='#FF00FF', linestyle='--', alpha=1)
        plt.scatter(BEST_REGULMLP_simulationAccuracy, BEST_REGULMLP_simulationPower, color="#FFBB00", marker='+')
        if BEST_REGULMAP_simulationAccuracy < 1e10 and BEST_REGULMAP_simulationPower < 1e10:
            plt.scatter(BEST_REGULMAP_simulationAccuracy, BEST_REGULMAP_simulationPower, color='#0000FF', marker='+')
        if BEST_REGULALL_simulationAccuracy < 1e10 and BEST_REGULALL_simulationPower < 1e10:
            plt.scatter(BEST_REGULALL_simulationAccuracy, BEST_REGULALL_simulationPower, color='#D3D3D3', marker='+')

    plt.scatter(BEST_REF_rmse_after, onp.sqrt(BEST_REF_powers_msv_after), color='#000000', label='reference')
    plt.scatter(BEST_NOPCS_rmse_after, onp.sqrt(BEST_NOPCS_powers_msv_after), color='#FF0000', label='no pcs')
    plt.scatter(BEST_NOMAP_rmse_after, onp.sqrt(BEST_NOMAP_powers_msv_after), color='#008000', label='no map')
    plt.scatter(BEST_DIAGMAP_rmse_after, onp.sqrt(BEST_DIAGMAP_powers_msv_after), color='#00FFFF', label='diagonal map')
    y_axis_max = plt.ylim()[1] if y_axis_max is None else y_axis_max
    plt.vlines(BEST_NOMLP_rmse_after, -1, y_axis_max, color='#FF00FF', alpha=1, label='no fb controller')
    plt.scatter(BEST_REGULMLP_rmse_after, onp.sqrt(BEST_REGULMLP_powers_msv_after), color='#FFBB00', label='control penalty')
    plt.scatter(BEST_REGULMAP_rmse_after, onp.sqrt(BEST_REGULMAP_powers_msv_after), color='#0000FF', label='map penalty')
    plt.scatter(BEST_REGULALL_rmse_after, onp.sqrt(BEST_REGULALL_powers_msv_after), color='#D3D3D3', label='map+control penalty')
    ...
    if do_ref_case and do_nopcs_case and do_nomap_case and do_diagmap_case and do_nomlp_case and do_regulmlp_case and do_regulmap_case:
        plt.scatter(BEST_REF_simulationAccuracy, BEST_REF_simulationMapeffort, color='#000000', marker='+')
        plt.scatter(BEST_NOPCS_simulationAccuracy, BEST_NOPCS_simulationMapeffort, color='#FF0000', marker='+')
        plt.scatter(BEST_NOMAP_simulationAccuracy, BEST_NOMAP_simulationMapeffort, color='#008000', marker='+')
        plt.scatter(BEST_DIAGMAP_simulationAccuracy, BEST_DIAGMAP_simulationMapeffort, color='#00FFFF', marker='+')
        plt.scatter(BEST_NOMLP_simulationAccuracy, BEST_NOMLP_simulationMapeffort, color='#FF00FF', marker='+')
        plt.scatter(BEST_REGULMLP_simulationAccuracy, BEST_REGULMLP_simulationMapeffort, color='#FFBB00', marker='+')
        plt.scatter(BEST_REGULMAP_simulationAccuracy, BEST_REGULMAP_simulationMapeffort, color='#0000FF', marker='+')
        plt.scatter(BEST_REGULALL_simulationAccuracy, BEST_REGULALL_simulationMapeffort, color='#D3D3D3', marker='+')

    plt.scatter(BEST_REF_rmse_after, BEST_REF_mapping_effort_after, color='#000000', label=f'reference (cond(A)={BEST_REF_condAinv:.2f})')
    plt.scatter(BEST_NOPCS_rmse_after, BEST_NOPCS_mapping_effort_after, color='#FF0000', label=f'no pcs (cond(A)={BEST_NOPCS_condAinv:.2f})')
    plt.scatter(BEST_NOMAP_rmse_after, BEST_NOMAP_mapping_effort_after, color='#008000', label=f'no map (cond(A)={BEST_NOMAP_condAinv:.2f})')
    plt.scatter(BEST_DIAGMAP_rmse_after, BEST_DIAGMAP_mapping_effort_after, color='#00FFFF', label=f'diagonal map (cond(A)={BEST_DIAGMAP_condAinv:.2f})')
    plt.scatter(BEST_NOMLP_rmse_after, BEST_NOMLP_mapping_effort_after, color='#FF00FF', label=f'no fb controller (cond(A)={BEST_NOMLP_condAinv:.2f})')
    plt.scatter(BEST_REGULMLP_rmse_after, BEST_REGULMLP_mapping_effort_after, color='#FFBB00', label=f'control penalty (cond(A)={BEST_REGULMLP_condAinv:.2f})')
    plt.scatter(BEST_REGULMAP_rmse_after, BEST_REGULMAP_mapping_effort_after, color='#0000FF', label=f'map penalty (cond(A)={BEST_REGULMAP_condAinv:.2f})')
    plt.scatter(BEST_REGULALL_rmse_after, BEST_REGULALL_mapping_effort_after, color='#D3D3D3', label=f'map+control penalty (cond(A)={BEST_REGULALL_condAinv:.2f})')
    ...
    # Save metrics
    with open(plots_folder/'metrics.txt', 'w') as file:
            file.write(f'----------ACCURACY (RMSE)----------\n')
            file.write(f'TEST SET:\n')
            file.write(f'   reference = {BEST_REF_rmse_after}\n')
            file.write(f'   no PCS =    {BEST_NOPCS_rmse_after}\n')
            file.write(f'   no map =    {BEST_NOMAP_rmse_after}\n')
            file.write(f'   diag map =  {BEST_DIAGMAP_rmse_after}\n')
            file.write(f'   no fb =     {BEST_NOMLP_rmse_after}\n')
            file.write(f'   regul fb =  {BEST_REGULMLP_rmse_after}\n')
            file.write(f'   regul map = {BEST_REGULMAP_rmse_after}\n')
            file.write(f'   regul all = {BEST_REGULALL_rmse_after}\n')
            file.write(f'SIMULATION:\n')
            file.write(f'   reference = {BEST_REF_simulationAccuracy}\n')
            file.write(f'   no PCS =    {BEST_NOPCS_simulationAccuracy}\n')
            file.write(f'   no map =    {BEST_NOMAP_simulationAccuracy}\n')
            file.write(f'   diag map =  {BEST_DIAGMAP_simulationAccuracy}\n')
            file.write(f'   no fb =     {BEST_NOMLP_simulationAccuracy}\n')
            file.write(f'   regul fb =  {BEST_REGULMLP_simulationAccuracy}\n')
            file.write(f'   regul map = {BEST_REGULMAP_simulationAccuracy}\n')
            file.write(f'   regul all = {BEST_REGULALL_simulationAccuracy}\n')
            file.write(f'\n\n----------POWER (RMSV)----------\n')
            file.write(f'TEST SET:\n')
            file.write(f'   reference = {onp.sqrt(BEST_REF_powers_msv_after)}\n')
            file.write(f'   no PCS =    {onp.sqrt(BEST_NOPCS_powers_msv_after)}\n')
            file.write(f'   no map =    {onp.sqrt(BEST_NOMAP_powers_msv_after)}\n')
            file.write(f'   diag map =  {onp.sqrt(BEST_DIAGMAP_powers_msv_after)}\n')
            file.write(f'   no fb =     {onp.sqrt(BEST_NOMLP_powers_msv_after)}\n')
            file.write(f'   regul fb =  {onp.sqrt(BEST_REGULMLP_powers_msv_after)}\n')
            file.write(f'   regul map = {onp.sqrt(BEST_REGULMAP_powers_msv_after)}\n')
            file.write(f'   regul all = {onp.sqrt(BEST_REGULALL_powers_msv_after)}\n')
            file.write(f'SIMULATION:\n')
            file.write(f'   reference = {BEST_REF_simulationPower}\n')
            file.write(f'   no PCS =    {BEST_NOPCS_simulationPower}\n')
            file.write(f'   no map =    {BEST_NOMAP_simulationPower}\n')
            file.write(f'   diag map =  {BEST_DIAGMAP_simulationPower}\n')
            file.write(f'   no fb =     {BEST_NOMLP_simulationPower}\n')
            file.write(f'   regul fb =  {BEST_REGULMLP_simulationPower}\n')
            file.write(f'   regul map = {BEST_REGULMAP_simulationPower}\n')
            file.write(f'   regul all = {BEST_REGULALL_simulationPower}\n')
            file.write(f'\n\n----------MAP EFFORT (Ek ratio)----------\n')
            file.write(f'TEST SET:\n')
            file.write(f'   reference = {BEST_REF_mapping_effort_after}\n')
            file.write(f'   no PCS =    {BEST_NOPCS_mapping_effort_after}\n')
            file.write(f'   no map =    {BEST_NOMAP_mapping_effort_after}\n')
            file.write(f'   diag map =  {BEST_DIAGMAP_mapping_effort_after}\n')
            file.write(f'   no fb =     {BEST_NOMLP_mapping_effort_after}\n')
            file.write(f'   regul fb =  {BEST_REGULMLP_mapping_effort_after}\n')
            file.write(f'   regul map = {BEST_REGULMAP_mapping_effort_after}\n')
            file.write(f'   regul all = {BEST_REGULALL_mapping_effort_after}\n')
            file.write(f'SIMULATION:\n')
            file.write(f'   reference = {BEST_REF_simulationMapeffort}\n')
            file.write(f'   no PCS =    {BEST_NOPCS_simulationMapeffort}\n')
            file.write(f'   no map =    {BEST_NOMAP_simulationMapeffort}\n')
            file.write(f'   diag map =  {BEST_DIAGMAP_simulationMapeffort}\n')
            file.write(f'   no fb =     {BEST_NOMLP_simulationMapeffort}\n')
            file.write(f'   regul fb =  {BEST_REGULMLP_simulationMapeffort}\n')
