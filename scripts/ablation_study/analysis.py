...
if do_overall:
    ...
    plt.scatter(SAMPLES_REGULMLP_all_rmse_after, onp.sqrt(SAMPLES_REGULMLP_all_powers_msv_after), color='#FFBB00', label='control penality')
    plt.scatter(SAMPLES_REGULMAP_all_rmse_after, onp.sqrt(SAMPLES_REGULMAP_all_powers_msv_after), color='#0000FF', label='map penality')
    plt.scatter(SAMPLES_REGULALL_all_rmse_after, onp.sqrt(SAMPLES_REGULALL_all_powers_msv_after), color='#D3D3D3', label='map+control penality')
    plt.xscale('log')
    plt.yscale('log')
    plt.grid(True)
    ...
    plt.scatter(SAMPLES_REGULMLP_all_rmse_after, SAMPLES_REGULMLP_mapping_effort_after, color='#FFBB00', label='control penality')
    plt.scatter(SAMPLES_REGULMAP_all_rmse_after, SAMPLES_REGULMAP_mapping_effort_after, color='#0000FF', label='map penality')
    plt.scatter(SAMPLES_REGULALL_all_rmse_after, SAMPLES_REGULALL_mapping_effort_after, color='#D3D3D3', label='map+control penality')
    plt.xscale('log')
    plt.yscale('log')
    plt.grid(True)
    plt.xlabel('RMS error on test set')
    ...
    plt.figure()
    plt.plot(1+onp.arange(len(REF_val_loss_ts)), REF_val_loss_ts, color='#000000', label='reference')
    plt.plot(1+onp.arange(len(NOPCS_val_loss_ts)), NOPCS_val_loss_ts, color='#FF0000', label='no pcs')
    plt.plot(1+onp.arange(len(NOMAP_val_loss_ts)), NOMAP_val_loss_ts, color='#008000', label='no map')
    plt.plot(1+onp.arange(len(DIAGMAP_val_loss_ts)), DIAGMAP_val_loss_ts, color='#00FFFF', label='diagonal map')
    plt.plot(1+onp.arange(len(NOMLP_val_loss_ts)), NOMLP_val_loss_ts, color='#FF00FF', label='no fb controller')
    plt.plot(1+onp.arange(len(REGULMLP_val_mse_ts)), REGULMLP_val_mse_ts, color="#FFBB00", label='control penality')
    plt.plot(1+onp.arange(len(REGULMAP_val_mse_ts)), REGULMAP_val_mse_ts, color='#0000FF', label='map penality')
    plt.plot(1+onp.arange(len(REGULALL_val_mse_ts)), REGULALL_val_mse_ts, color='#D3D3D3', label='map+control penality')
    plt.grid(True)
    plt.xlabel('epoch')
    plt.ylabel('MSE')
    ...
    plt.scatter(BEST_REGULMLP_rmse_after, onp.sqrt(BEST_REGULMLP_powers_msv_after), color='#FFBB00', label='control penality')
    plt.scatter(BEST_REGULMAP_rmse_after, onp.sqrt(BEST_REGULMAP_powers_msv_after), color='#0000FF', label='map penality')
    plt.scatter(BEST_REGULALL_rmse_after, onp.sqrt(BEST_REGULALL_powers_msv_after), color='#D3D3D3', label='map+control penality')
    ...
    plt.scatter(BEST_REGULMLP_rmse_after, BEST_REGULMLP_mapping_effort_after, color='#FFBB00', label=f'control penality (cond(A)={BEST_REGULMLP_condAinv:.2f})')
    plt.scatter(BEST_REGULMAP_rmse_after, BEST_REGULMAP_mapping_effort_after, color='#0000FF', label=f'map penality (cond(A)={BEST_REGULMAP_condAinv:.2f})')
    plt.scatter(BEST_REGULALL_rmse_after, BEST_REGULALL_mapping_effort_after, color='#D3D3D3', label=f'map+control penality (cond(A)={BEST_REGULALL_condAinv:.2f})')
