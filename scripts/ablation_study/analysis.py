...
if do_overall:
    ...
    plt.plot(1+onp.arange(len(REGULMLP_val_mse_ts)), REGULMLP_val_mse_ts, color="#FFBB00", label='control penalty')
    plt.plot(1+onp.arange(len(REGULMAP_val_mse_ts)), REGULMAP_val_mse_ts, color='#0000FF', label='map penalty')
    plt.plot(1+onp.arange(len(REGULALL_val_mse_ts)), REGULALL_val_mse_ts, color='#D3D3D3', label='map+control penalty')
    plt.grid(True)
    plt.xlabel('epoch')
    plt.ylabel('MSE')
