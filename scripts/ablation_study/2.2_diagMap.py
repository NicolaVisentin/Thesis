...
if train_samples:
    ...
    # Mapping (diagonal matrix in this case): first 10 samples defined "by hand", remaining 20 sampled
    s_thresh = 1e-5
    A0_first10 = jnp.array(
    ...
    key, keyA1, keyA2 = jax.random.split(key, 3)
    ...
    # Mapping
    s_thresh = 1e-5 # min threshold for s_i during optimization
