...
load_case_prefix = '2.1_TANHQ_SVD_SAMPLES' # if train_samples is False, choose prefix of the experiment to load
...
for i in range(n_samples):
    ...
    tau_i = mlp_controller._forward_batch(params_i, q) # shape (testset_size, 3*n_pcs)
