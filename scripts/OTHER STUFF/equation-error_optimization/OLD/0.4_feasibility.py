...
dataset = onp.load(dataset_folder/'soft robot optimization/sMNIST_RON_N6_noInput/dataset_m1e4_N6_noInput.npz')
...
u = jnp.zeros((y.shape[0],1)) # input of the RON oscillators. Shape (m, n_inp)
