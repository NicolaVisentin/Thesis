...
ron_dataset = 'sMNIST_ESN_N6_DT0.02/dataset_m1e5_N6_DT0.02' # name of the case to load from 'soft robot optimization' folder
ron_evolution_example = 'sMNIST_ESN_N6_DT0.02/ESN_evolution_N6_DT0.02_long' # name of the case to load from 'soft robot optimization' folder
